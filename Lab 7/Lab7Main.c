...
void createBall(){
	for(int x=0;x<100;x++){
		for(int y=0;y<100;y++){
			int i = x+100*y;
			basketballImg[i] = 0xFFFF;
			
			float distsqr = (x-49)*(x-49)+(y-49)*(y-49);
			int insideCircle = distsqr<2500;
			if(insideCircle){
				//basketballImg[i] = 0x06CF;
				basketballImg[i] = 0x063F;
				//basketballImg[i] = 0x001F;
			}
			if(x>=47&&x<51){
				basketballImg[i] = 0x0000;
			}
			if(y>=47&&y<51){
				basketballImg[i] = 0x0000;
			}
			float dist1sqr = (x-0)*(x-0)+(y-49)*(y-49);
			float dist2sqr = (x-99)*(x-99)+(y-49)*(y-49);
			
			if(insideCircle && ((dist1sqr>1225&&dist1sqr<1521)||(dist2sqr>=1225&&dist2sqr<1521))){
				basketballImg[i] = 0x0000;
			}
...
int main(void){
  ...
  for(i=0;i<SIZE;i++){
	...
	createBall();
	ST7735_DrawBitmap(10,110,basketballImg,100,100);
